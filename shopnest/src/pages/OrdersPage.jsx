    ...
    <div className="min-h-screen bg-[#f1f3f6] py-6 font-sans">
      <div className="max-w-4xl mx-auto px-4">
        <div className="flex items-center justify-between mb-6">
          <h1 className="text-[22px] font-semibold text-gray-800">My Orders</h1>
          <Link to="/" className="bg-[#2874f0] text-white px-4 py-2 rounded-sm text-[14px] font-medium hover:bg-[#1a65d6] transition-colors flex items-center gap-2">
            Continue Shopping
          </Link>
        </div>
